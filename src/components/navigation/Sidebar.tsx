...
import { LayoutDashboard, ShoppingBag, Users, Package, BarChart3 } from 'lucide-react';
    ...
    <div className="w-64 bg-white shadow-sm border-r border-gray-200 h-screen flex flex-col">
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="bg-gradient-to-r from-blue-500 to-teal-500 p-4 rounded-lg text-white">
          ...
          <p className="text-xs opacity-90 mt-1">Get advanced analytics and reporting features</p>
        </div>
      </div>
    </div>
  );
